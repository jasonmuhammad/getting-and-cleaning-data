...
download.file(fileurl,destfile="./wearabledata/Dataset.zip",method="curl")

unzip(zipfile = "./wearabledata/Dataset.zip", exdir = "./wearabledata")
path_rf <- file.path("./wearabledata", "UCI Har Datasets")
